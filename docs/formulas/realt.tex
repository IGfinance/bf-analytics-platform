...
% в среде БЕЗ LaTeX-движка (tectonic/xelatex недоступны) — визуальная
% проверка сборкой НЕ переделана. Перед тем как считать документ
% актуальным для клиента — пересобрать и визуально проверить (см. команду
% выше), особенно новые формулы и обновлённый раздел 4.
